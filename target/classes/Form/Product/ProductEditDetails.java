...
public class ProductEditDetails extends javax.swing.JPanel {
    ...
    private void Init(TypeFunction type)
    {
        ...
        if(type == TypeFunction.Edit)
        {
            ...
            ArrayList<ProductVariants> productVariantList = new ArrayList<>();
            productVariantList = productVariant_Dao.getProductVariantList(product_target.getID());
            ...
            productImageList = productImage_Dao.getProductImageList(product_target.getID());
    ...
    private boolean ImportData()
    {
        try{
            ...
            int ProducID = product_Dao.AddProduct(product);
            if(ProducID == -1)
            {
                return false;
            }
