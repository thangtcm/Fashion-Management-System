    ...
    public PasswordField() {
        ...
        addMouseListener(new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent me) {
                if (showAndHide) {
                    int x = getWidth() - 30;
                    int y = (getHeight() - spaceHelperText) / 2;
        ...
        eye = new ImageIcon(getClass().getResource("/Images/icon/eye.png")).getImage();
        eye_hide = new ImageIcon(getClass().getResource("/Images/icon/eye_hide.png")).getImage();
